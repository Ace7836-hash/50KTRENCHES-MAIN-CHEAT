--// ✅ FULL KEY SYSTEM + LOADING + RAYFIELD MENU (FIXED)
-- CONFIG
...
-- Title (nilagyan ng text para hindi blank)
...
gui:Destroy() -- alisin yung key system UI  
    ...
    wait(2) -- ilang segundo mag stay ang loading screen  
    loadingGui:Destroy()  
...
-- ✅ FIXED error block (dito ang core fix mo)
status.Text = """
